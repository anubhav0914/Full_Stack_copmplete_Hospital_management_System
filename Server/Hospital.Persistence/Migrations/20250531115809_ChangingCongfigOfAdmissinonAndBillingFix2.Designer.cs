...
namespace Hospital.Persistence.Migrations
{
    ...
    [Migration("20250531115809_ChangingCongfigOfAdmissinonAndBillingFix2")]
    partial class ChangingCongfigOfAdmissinonAndBillingFix2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Persistence.Models.BillingTransaction", b =>
                {
                    ...
                    b.Property<int>("AdmissionAdmitId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital.Persistence.Models.BillingTransaction", b =>
                {
                    b.HasOne("Hospital.Persistence.Models.AdmissionDischarge", "Admission")
                        .WithMany()
                        .HasForeignKey("AdmissionAdmitId")
