...
const PatientDashboard = () => {
  ...
  return (
    <div className="bg-green-100 p-6 text-base font-sans mt-20">
      {/* Title */}
            ...
            <table className="min-w-full border border-gray-300 text-lg rounded-lg">
              <thead className="bg-green-200 text-green-800">
                <tr>
                  ...
                  <th className="text-left py-4 px-6 border-b">Doctor Specialization</th>
                  <th className="text-left py-4 px-6 border-b">Appointment Date </th>
              ...
              <tbody>
                {appointnets.map((appt, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}>
                    ...
                    <td className="py-4 px-6 border-b">{getSpecialization(appt.doctorId)}</td>
      ...
      {messge ? (
        <div className="bg-white border-2 border-green-800 max-w-6xl mx-auto mt-8 p-6 flex justify-center items-center text-center text-red-400 text-2xl">
          {messge}
        </div>
      ) : null}
